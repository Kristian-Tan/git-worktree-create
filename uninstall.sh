...
rm "$install_directory_target/git-worktree-create.sh" || exit_on_error "cannot remove git-worktree-create.sh, is it already installed?"
rm "$install_directory_target/git-worktree-create" || exit_on_error "cannot remove git-worktree-create, is it already installed?"
